...
def main():
    ...
    printTabela(tab)
    print("__________________________________________B_________________________________________")
    ...
    printTabela(tab)
    print("________________________________C___________________________________________________")
    ...
    printTabela(tab)
    print("_______________________________D___________________________________________________")
